export const words = {
  en: {
    ...
    favoriteTitle:'Favorite ideas',favoriteSubtitle:'Save models you want to print later.',addFavorite:'Add favorite',tags:'Tags',preferredFilament:'Preferred filament',moveToQueue:'Move to queue',noFavorites:'No favorite ideas',designSites:'Popular design sites',shopOnAmazon:'Shop PLA on Amazon',AliExpress:'Shop PLA on AliExpress',
    inventoryTitle:'Filament inventory',inventorySubtitle:'Track ownership, cost, and remaining material.',addFilament:'Add filament',material:'Material',color:'Color',owners:'Owners',remaining:'Remaining',pricePerGram:'Price / gram',usage:'Usage',normal:'Normal',lowFilament:'Low filament',empty:'Empty',viewLog:'Usage log',noFilaments:'No filaments found',finishedFilaments:'Finished filament',
    ...
    historyTitle:'Print history',historySubtitle:'Completed, failed, and canceled jobs.',allResults:'All results',result:'Result',date:'Date',note:'Note',noHistory:'No print history',requeue:'Requeue',
    ...
    save:'Save',close:'Close',modelLink:'Model/file link',uploadModel:'Upload model file',chooseModelFile:'Choose model file',noModelFileChosen:'No file selected',modelInputHint:'Attach a .stl or .3mf file (maximum 100 MB), or provide a link above.',attachedModel:'Attached model',downloadModel:'Download model',imageUrl:'Image URL',notes:'Notes',durationMinutes:'Duration (minutes)',selectFilament:'Select filament',low:'Low',high:'High',title:'Title',type:'Type',printer:'Printer',totalCost:'Total cost (SAR)',invoiceLink:'Invoice link',receiptImage:'Receipt image URL',amountPaid:'Amount paid',paymentsEqual:'Payments must equal the total cost.',purchaseDate:'Purchase date',totalWeight:'Total weight (g)',remainingWeight:'Remaining weight (g)',price:'Price (SAR)',colorHex:'Color preview',resultNote:'Result note / reason',actualGrams:'Actual or wasted grams',confirm:'Confirm',createdBy:'Created by',finishedBy:'Finished by',noData:'No data available',minutes:'min',grams:'g',sar:'SAR',view:'View'
  },
  ar: {
    ...
    favoriteTitle:'الأفكار المفضلة',favoriteSubtitle:'احفظ المجسمات التي تريد طباعتها لاحقًا.',addFavorite:'إضافة للمفضلة',tags:'الوسوم',preferredFilament:'الفيلمنت المفضل',moveToQueue:'نقل للطابور',noFavorites:'لا توجد أفكار مفضلة',designSites:'أشهر مواقع التصاميم الجاهزة',shopOnAmazon:'تسوق PLA من أمازون',AliExpress:'تسوق PLA من علي إكسبريس',
    inventoryTitle:'مخزون الفيلمنت',inventorySubtitle:'تابع الملكية والتكلفة والكمية المتبقية.',addFilament:'إضافة فيلمنت',material:'المادة',color:'اللون',owners:'الملاك',remaining:'المتبقي',pricePerGram:'سعر الجرام',usage:'الاستخدام',normal:'طبيعي',lowFilament:'فيلمنت منخفض',empty:'فارغ',viewLog:'سجل الاستخدام',noFilaments:'لا توجد بكرات',finishedFilaments:'الفيلمنت المنتهي',
    ...
    historyTitle:'سجل الطباعة',historySubtitle:'الطبعات المكتملة والفاشلة والملغاة.',allResults:'كل النتائج',result:'النتيجة',date:'التاريخ',note:'الملاحظة',noHistory:'لا يوجد سجل طباعة',requeue:'إعادة للطابور',
    ...
    save:'حفظ',close:'إغلاق',modelLink:'رابط الملف/المجسم',uploadModel:'رفع ملف المجسم',chooseModelFile:'اختيار ملف المجسم',noModelFileChosen:'لم يتم اختيار ملف',modelInputHint:'أرفق ملف .stl أو .3mf (بحد أقصى 100 MB)، أو أضف الرابط بالأعلى.',attachedModel:'ملف مرفق',downloadModel:'تحميل ملف المجسم',imageUrl:'رابط الصورة',notes:'ملاحظات',durationMinutes:'المدة (بالدقائق)',selectFilament:'اختر الفيلمنت',low:'منخفضة',high:'عالية',title:'العنوان',type:'النوع',printer:'الطابعة',totalCost:'إجمالي التكلفة (ر.س)',invoiceLink:'رابط الفاتورة',receiptImage:'رابط صورة الإيصال',amountPaid:'المبلغ المدفوع',paymentsEqual:'يجب أن يساوي مجموع المدفوعات التكلفة الإجمالية.',purchaseDate:'تاريخ الشراء',totalWeight:'الوزن الإجمالي (جم)',remainingWeight:'الوزن المتبقي (جم)',price:'السعر (ر.س)',colorHex:'معاينة اللون',resultNote:'ملاحظة النتيجة / السبب',actualGrams:'الجرامات الفعلية أو المهدرة',confirm:'تأكيد',createdBy:'أضيف بواسطة',finishedBy:'أنهاها',noData:'لا توجد بيانات',minutes:'دقيقة',grams:'جم',sar:'ر.س',view:'عرض'
  }
};
...
export function fmtNum(value, language, digits = 0) {
  return new Intl.NumberFormat(language === 'ar' ? 'ar-SA' : 'en-US', { maximumFractionDigits: digits }).format(Number(value || 0));
}

// Financial values stay in Latin digits even when the interface is Arabic.
